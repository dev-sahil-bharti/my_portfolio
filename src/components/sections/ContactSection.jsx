...
export default function SocialSection() {
    return (
        <>
            <div className='bg-black text-white text-center pb-12' id="contact">
                <div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 sm:gap-6 max-w-md">
                        <div className="">
                            <a href={social.gmail.url}>
                                <img src={social.gmail.image} className="w-[55px] sm:w-[65px] p-1 transition-transform duration-300 hover:scale-110" alt="Gmail Logo" />
                            </a>
                        </div>
                        <div className="">
                            <a href={social.github.url}>
                                <img src={social.github.image} className="w-[55px] sm:w-[65px] p-1 transition-transform duration-300 hover:scale-110" alt="Github Logo" />
                            </a>
                        </div>
                        <div className="">
                            <a href={social.linkedin.url}>
                                <img src={social.linkedin.image} className="w-[55px] sm:w-[65px] p-1 transition-transform duration-300 hover:scale-110" alt="LinkedIn Logo" />
                            </a>
                        </div>
                        <div className="">
                            <a href={social.twitter.url}>
                                <img src={social.twitter.image} className="w-[55px] sm:w-[65px] p-1 transition-transform duration-300 hover:scale-110" alt="Twitter Logo" />
                            </a>
                        </div>
                        <div className="">
                            <a href={social.instagram.url}>
                                <img src={social.instagram.image} className="w-[55px] sm:w-[65px] p-1 transition-transform duration-300 hover:scale-110" alt="Instagram Logo" />
                            </a>
                        </div>
                    </div>
